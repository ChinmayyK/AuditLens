...
function HealthIndicator() {
  ...
  const [info, setInfo] = useState<{ version?: string; environment?: string; timestamp?: string } | null>(null)
...
export default function PRReviewPage() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      toast.error(getApiErrorMessage(err, 'Review failed. Check backend connection.'))
      setState('idle')
    }
  }
